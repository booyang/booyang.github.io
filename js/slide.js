...
(function($) {
	$.fn.slide = function(options) {
		...
		$("<ul style='width:" + ($(settings.slideContainer).length * 0.3 + ($(settings.slideContainer).length - 1) * 0.2) + "em;margin-left:-" + ($(settings.slideContainer).length * 0.3 + (($(settings.slideContainer).length - 1) * 0.2)) / 2 + "em' class='navListBox'>" + navlist + "</ul>").appendTo(el.parent());
