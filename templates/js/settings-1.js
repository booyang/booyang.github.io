...
var f = {};
 ...
 // service ------------------------------------
  ...
  f.Florist_image    = f.first;
  f.app01_image    = f.Florist_image  +300;
  f.Youzon_image   = f.app01_image + 300;
  f.Spex_image     = f.Youzon_image + 300;
   f.Sasanov_image  = f.Spex_image  +300;
  f.MIS_image      = f.Sasanov_image  + 300;
  f.Licha_image    = f.MIS_image      + 300;
  f.Angel_image     = f.Licha_image     + 300;
  f.Sasa_image       = f.Angel_image  +300;
  f.Enrestec_image   = f.Sasa_image   + 300;
...
settings = [
  {
    ...
    frame: [ f.start, f.internet, f.media, f.team, f.team_move, f.light, f.egg, f.wawa, f.sliiice, f.project, f.project_move, f.project_end, f.contact ],
    style: {
      left: [550,     '-200',     '+200',  -800,   -1150,       -1500, '-248*3', '+248',    '-550',    '0',    '-450',        '-250*350/250*41', '-300'],
      top:  [  0,      -1280,     -1700, ' +60',   '+60',       '+60', '-248*3', '-248',  '-290*13', '-400',    '+40',        '+42*350/250*43', '+130']
    }
  },
  {
  ...
  */
  ...
  {
    selector: "#project-Florist",
    frame: [f.Florist_image, f.Florist_image+300],
  },
  {
    selector: "#project-app01",
    frame: [f.app01_image, f.app01_image+300],
  },
  {
    selector: "#project-Youzon",
    frame: [f.Youzon_image, f.Youzon_image+300],
  },
  {
    selector: "#project-Spex",
    frame: [f.Spex_image, f.Spex_image+300],
  },

  {
    selector: "#project-Sasanov",
    frame: [f.Sasanov_image, f.Sasanov_image+300],
  },
   {
    selector: "#project-MIS",
    frame: [f.MIS_image, f.MIS_image+300],
  },
  {
    selector: "#project-Licha",
    frame: [f.Licha_image, f.Licha_image+300],
  },
  {
    selector: "#project-Angel",
    frame: [f.Angel_image, f.Angel_image+300],
  },
  {
    selector: "#project-Sasa",
    frame: [f.Sasa_image, f.Sasa_image+300],
  },
  {
